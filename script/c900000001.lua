...
function s.spfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsAttribute(ATTRIBUTE_DARK) and c:HasLevel() and c:IsLevelAbove(1) and c:IsReleasable()
end
...
function s.filter(c)
	return c:IsCode(900000000) and c:IsAbleToHand()
end
